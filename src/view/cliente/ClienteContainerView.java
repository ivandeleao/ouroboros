 ...
 * @author ivand
 */
public class ClienteContainerView extends javax.swing.JInternalFrame {
    private Pessoa cliente;
    private static List<ClienteContainerView> clienteContainerViews = new ArrayList<>();
    ClienteCadastroView clienteCadastroView;
    ClienteCrediarioView clienteCrediarioView;
    
    public static ClienteContainerView getInstance(Pessoa cliente) {
        for (ClienteContainerView clienteContainerView : clienteContainerViews) {
            if (clienteContainerView.cliente == cliente) {
                return clienteContainerView;
            }
        }
        clienteContainerViews.add(new ClienteContainerView(cliente));
        return clienteContainerViews.get(clienteContainerViews.size() - 1);
    }
    
    private ClienteContainerView() {
        initComponents();
    }
    
    private ClienteContainerView(Pessoa cliente) {
        initComponents();
        System.out.println("novo container view...");
        this.cliente = cliente;
        clienteCadastroView = ClienteCadastroView.getInstance(cliente);
        ...
        ChangeListener changeListener = new ChangeListener() {
            ...
            public void stateChanged(ChangeEvent e) {
                ...
                switch(index){
                    case 0: //cadastro
                        iFrame = clienteCadastroView;
                        break;
                    case 1:
                        iFrame = clienteCrediarioView;
                        break;
                }
        ...
        exibirFrame(clienteCadastroView);
    ...
    public void gerarTabs(){
        if(cliente.getId() != null && tabPane.getTabCount() == 1){
            adicionarTab("Crediário");
            clienteCrediarioView = ClienteCrediarioView.getInstance(cliente);
        }
    }
    ...
    private void formInternalFrameClosed(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameClosed
        clienteContainerViews.remove(this);
        for(Component c : getComponents()){
            try {
                clienteCadastroView.setClosed(true);
                if(clienteCrediarioView != null) {
                    clienteCrediarioView.setClosed(true);
                }
