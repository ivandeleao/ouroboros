 ...
 *
 */
public class ClienteParcelaEditarView extends javax.swing.JDialog {
     ...
     */
    public ClienteParcelaEditarView(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }

    public ClienteParcelaEditarView(java.awt.Frame parent, Parcela parcela) {
        super(parent, true);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ClienteParcelaEditarView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ClienteParcelaEditarView dialog = new ClienteParcelaEditarView(new javax.swing.JFrame(), true);
