 ...
 *
 */
public class RecebimentoParcelaNovoView extends javax.swing.JDialog {
     ...
     */
    private RecebimentoParcelaNovoView(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }

    public RecebimentoParcelaNovoView(List<Parcela> parcelaList) {
    ...
    private void confirmar() {
        ...
        if(valorRecebido.compareTo(BigDecimal.ZERO) <= 0) {
            ...
            for(Parcela parcela : parcelas) {
                ...
                if(valorRestante.compareTo(BigDecimal.ZERO) > 0) {
                    ...
                    if(valorRestante.compareTo(parcela.getValorAtual()) >= 0) {
                        valorLancamento = parcela.getValorAtual();
                    } else {
                    ...
                    CaixaItem caixaItem;
                    //Entrada ou Saída
                    if (parcela.getVenda().getTipoOperacao().equals(TipoOperacao.SAIDA)) {
                        caixaItem = new CaixaItem(CaixaItemTipo.DOCUMENTO, meioPagamento, "", valorLancamento, BigDecimal.ZERO);
                    } else {
                        caixaItem = new CaixaItem(CaixaItemTipo.DOCUMENTO, meioPagamento, "", BigDecimal.ZERO, valorLancamento);
                    }
                    //
            ...
            if (parcelas.get(0).getVenda().getTipoOperacao().equals(TipoOperacao.SAIDA)) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("*Acréscimo e Desconto são editávies apenas se não definido anteriormente");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RecebimentoParcelaNovoView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                RecebimentoParcelaNovoView dialog = new RecebimentoParcelaNovoView(new javax.swing.JFrame(), true);
