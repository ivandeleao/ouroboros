 ...
 * @author ivand
 */
public class ContaSuprimentoView extends javax.swing.JDialog {
     ...
     */
    public ContaSuprimentoView(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        JSwing.startComponentsBehavior(this);
    }
    
    public ContaSuprimentoView(Conta conta) {
    ...
    private void confirmar(){
        ...
        if(valor.compareTo(BigDecimal.ZERO) <= 0){
            ...
            caixaItem = new CaixaItem(CaixaItemTipo.SUPRIMENTO, mp, observacao, valor, BigDecimal.ZERO);
            
            //conta.addCaixaItem(caixaItem); 2020-06-03 pra não carregar o bag (pois não usa)
    ...
    private void initComponents() {
        ...
        txtValor.setForeground(java.awt.Color.blue);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ContaSuprimentoView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ContaSuprimentoView dialog = new ContaSuprimentoView(new javax.swing.JFrame(), true);
