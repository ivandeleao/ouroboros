...
import model.mysql.dao.principal.financeiro.ContaProgramadaBaixaDAO;
...
public class ContaProgramadaPagarView extends javax.swing.JDialog {
    ...
    private void confirmar() {
        ...
        if(valorPago.compareTo(BigDecimal.ZERO) == 0) {
            int resposta = JOptionPane.showConfirmDialog(MAIN_VIEW, "Tem certeza que deseja baixar esta conta com valor ZERO?", "Atenção", JOptionPane.YES_NO_OPTION);
            if(resposta == JOptionPane.OK_OPTION) {
                contaProgramadaBaixaDAO.baixar(contaPagar, valorPago, meioDePagamento, observacao, conta);
                dispose();
    ...
    private void initComponents() {
        ...
        setTitle("Pagar Conta Programada");
        setResizable(false);
        ...
        jLabel1.setText("Conta Programada");
        ...
        jLabel7.setText("Data Conta Fluxo");
        ...
        txtValorPago.setForeground(java.awt.Color.red);
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addComponent(cboConta, 0, 268, Short.MAX_VALUE)
                                .addGap(18, 18, 18)
                                .addComponent(jLabel7)))
                        .addGap(18, 18, 18)
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(txtData)
                            .addComponent(txtValorPago, javax.swing.GroupLayout.DEFAULT_SIZE, 119, Short.MAX_VALUE)))
