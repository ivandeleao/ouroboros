...
import view.grupo.GrupoListaView;

/**
 *
 * @author ivand
 */
public class PessoaGeralContainerView extends javax.swing.JInternalFrame {
    ...
    public static PessoaGeralContainerView getSingleInstance(){
        ...
        if(singleInstance == null){
            singleInstance = new PessoaGeralContainerView();
        }
        
        return singleInstance;
    }
    
    private PessoaGeralContainerView() {
        initComponents();
        System.out.println("novo pessoa geral container view...");
        
        pessoaListaView = PessoaListaView.getSingleInstance();
