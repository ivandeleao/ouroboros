...
public class PessoaCrediarioRecebimentoView extends javax.swing.JDialog {
     ...
     */
    public PessoaCrediarioRecebimentoView(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }

    public PessoaCrediarioRecebimentoView(java.awt.Frame parent, List<Parcela> parcelaList) {
        super(parent, true);
        initComponents();
                ...
                do {
                    ...
                    for(Map.Entry<MeioDePagamento, BigDecimal> mpValor : mapMpValor.entrySet()){
                        if(mpValor.getValue().compareTo(BigDecimal.ZERO) > 0) {
                            ...
                            CaixaItem recebimento = new CaixaItem(caixa, CaixaItemTipo.RECEBIMENTO_DOCUMENTO, mp, "", credito, BigDecimal.ZERO);
    ...
    private void initComponents() {
        ...
        jTextArea1.setBackground(javax.swing.UIManager.getDefaults().getColor("TextArea.disabledBackground"));
        jTextArea1.setColumns(20);
        jTextArea1.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        jTextArea1.setRows(4);
        jTextArea1.setText("Vencimentos em finais de semana e feriados:\nJuros e multa não devem ser cobrados quando o pagamento for efetuado no primeiro dia útil subsequente.\nSe o pagamento for efetuado após o primeiro dia útil, os juros serão calculados em dias corridos deste o vencimento.\nEx: Se o vencimento for em um sábado e o pagamento efetuado na terça-feira, juros serão calculados sobre três dias de atraso.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PessoaCrediarioRecebimentoView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PessoaCrediarioRecebimentoView dialog = new PessoaCrediarioRecebimentoView(new javax.swing.JFrame(), true);
