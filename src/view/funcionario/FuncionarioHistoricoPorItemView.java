 ...
 * @author ivand
 */
public class FuncionarioHistoricoPorItemView extends javax.swing.JInternalFrame {
    private static List<FuncionarioHistoricoPorItemView> funcionarioHistoricoViews = new ArrayList<>(); //instâncias
    
    FuncionarioHistoricoPorItemJTableModel funcionarioHistoricoJTableModel = new FuncionarioHistoricoPorItemJTableModel();
    ...
    public static FuncionarioHistoricoPorItemView getInstance(Funcionario funcionario){
        for (FuncionarioHistoricoPorItemView veiculoHistoricoView : funcionarioHistoricoViews) {
            if (veiculoHistoricoView.funcionario == funcionario) {
                return veiculoHistoricoView;
            }
        }
        funcionarioHistoricoViews.add(new FuncionarioHistoricoPorItemView(funcionario));
        return funcionarioHistoricoViews.get(funcionarioHistoricoViews.size() - 1);
    }
    
    /**
     * Creates new form VendaListaView
     */
    private FuncionarioHistoricoPorItemView(Funcionario funcionario) {
        initComponents();
    ...
    private void formatarTabela() {
        tblVendas.setModel(funcionarioHistoricoJTableModel);
    ...
    private void carregarTabela() {
        ...
        listVenda = vendaDAO.findByFuncionarioPorItem(funcionario, dataInicial, dataFinal, vendaStatus);
        ...
        for (Venda venda : listVenda) {
            ...
            totalProdutos = totalProdutos.add(venda.getTotalProdutosPorFuncionario(funcionario));
            totalServicos = totalServicos.add(venda.getTotalServicosPorFuncionario(funcionario));
        }
        ...
        */
        ...
        funcionarioHistoricoJTableModel.clear();
        funcionarioHistoricoJTableModel.addList(listVenda, funcionario);
    ...
    private void tblVendasMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblVendasMouseClicked
        if (evt.getClickCount() == 2) {
            ...
            Venda venda = funcionarioHistoricoJTableModel.getRow(tblVendas.getSelectedRow());
            MAIN_VIEW.addView(VendaView.getInstance(venda));
        }
    }//GEN-LAST:event_tblVendasMouseClicked

    private void formInternalFrameClosed(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameClosed
        funcionarioHistoricoViews.remove(this);
