...
import model.jtable.catalogo.DocumentoItemTempJTableModel;
...
public class ImportarXmlEtapa3Produtos extends javax.swing.JDialog {
    ...
    private final DocumentoItemTempJTableModel produtoFornecedorJTableModel = new DocumentoItemTempJTableModel();
    ...
    private void formatarTabela() {
        tblItens.setModel(produtoFornecedorJTableModel);
        ...
        if (produtoFornecedorJTableModel.getRowCount() > 0) {
            tblItens.setRowSelectionInterval(0, 0);
        }
    }

    private void carregarTabela() {
        produtoFornecedorJTableModel.clear();

        produtoFornecedorJTableModel.addList(dets);
    }

    private void vincularProduto() {
        Prod prod = produtoFornecedorJTableModel.getRow(tblItens.getSelectedRow()).getProd();
