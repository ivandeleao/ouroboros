 ...
 * @author ivand
 */
public class NfeDocumentoReferenciadoCadastroView extends javax.swing.JDialog {
    ...
    private NfeDocumentoReferenciadoCadastroView(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    
    public NfeDocumentoReferenciadoCadastroView(DocumentoReferenciado documentoReferenciado) {
    ...
    public DocumentoReferenciado getDocumentoReferenciado() {
    ...
    private void carregarDados() {
        if(documentoReferenciado != null) {
            txtChave.setText(documentoReferenciado.getChave());
        }
    }
    ...
    private void salvar() {
        ...
        if(chave.length() != 44) {
            JOptionPane.showMessageDialog(rootPane, "A chave deve possuir 44 algarismos", "Atenção", JOptionPane.WARNING_MESSAGE);
            txtChave.requestFocus();
            
        } else {
            documentoReferenciado.setChave(chave);
            
            documentoReferenciado = documentoReferenciadoDAO.save(documentoReferenciado);
            dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NfeDocumentoReferenciadoCadastroView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                NfeDocumentoReferenciadoCadastroView dialog = new NfeDocumentoReferenciadoCadastroView(new javax.swing.JFrame(), true);
