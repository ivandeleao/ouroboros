 ...
 * @author ivand
 */
public class DocumentoSaidaPesquisaJTableModel extends AbstractTableModel {
    private final List<Venda> dados;
    private final String[] colunas = {"Id", "Tipo", "Status", "Data", "Funcionário", "NFSe", "Sat", "Total", "Em aberto"};

    public DocumentoSaidaPesquisaJTableModel() {
        dados = new ArrayList<>();
    }

    public DocumentoSaidaPesquisaJTableModel(List<Venda> vendas) {
        dados = vendas;
    }
