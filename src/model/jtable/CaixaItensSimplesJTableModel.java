 ...
 * @author ivand
 */
public class CaixaItensSimplesJTableModel extends AbstractTableModel {
    private final List<CaixaItem> dados;
    private final String[] colunas = {"Id", "Data Hora", "Tipo", "MP", "Crédito", "Débito"};

    public CaixaItensSimplesJTableModel() {
        dados = new ArrayList<>();
    }

    public CaixaItensSimplesJTableModel(List<CaixaItem> caixaItens) {
        dados = caixaItens;
    }
