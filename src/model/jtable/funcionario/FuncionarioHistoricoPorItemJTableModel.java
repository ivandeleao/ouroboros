 ...
 * @author ivand
 */
public class FuncionarioHistoricoPorItemJTableModel extends AbstractTableModel {
    private final List<Venda> dados;
    private Funcionario funcionario;
    private final String[] colunas = {"Documento", "Data", "Cliente", "Descrição", "Produtos", "Serviços"};

    public FuncionarioHistoricoPorItemJTableModel() {
        dados = new ArrayList<>();
        this.funcionario = null;
    }

    public FuncionarioHistoricoPorItemJTableModel(List<Venda> vendas, Funcionario funcionario) {
        dados = vendas;
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        ...
        switch (columnIndex) {
            ...
            case 3:
                return venda.getDescricaoConcatenada(funcionario);
            case 4:
                return Decimal.toString(venda.getTotalProdutosPorFuncionario(funcionario));
            case 5:
                return Decimal.toString(venda.getTotalServicosPorFuncionario(funcionario));
        }
        return null;
    }
    ...
    public void addList(List<Venda> vendas, Funcionario funcionario) {
