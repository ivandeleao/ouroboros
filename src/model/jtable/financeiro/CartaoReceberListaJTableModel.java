 ...
 * @author ivand
 */
public class CartaoReceberListaJTableModel extends AbstractTableModel {

    private final List<Parcela> dados;
    private final String[] colunas = {"Status", "Vencimento", "Venda", "Parcela", "Cliente", "Valor", "Taxa", "Líquido", "Valor Recebido", "Data Recebido", "Observação"};

    public CartaoReceberListaJTableModel() {
        dados = new ArrayList<>();
    }

    public CartaoReceberListaJTableModel(List<Parcela> ParcelaList) {
        dados = ParcelaList;
    }
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        try {
            ...
            switch (columnIndex) {
                ...
                case 7:
                    return Decimal.toString(parcela.getCartaoValorLiquido());
                case 8:
                    return Decimal.toString(parcela.getCartaoValorRecebido());
                case 9:
