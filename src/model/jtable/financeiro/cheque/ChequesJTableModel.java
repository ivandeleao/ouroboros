 ...
 * @author ivand
 */
public class ChequesJTableModel extends AbstractTableModel {

    private final List<Cheque> dados;
    private final String[] colunas = {"Id", "Vencimento", "Banco", "Agência", "Conta", "Número", "Correntista", "CPF/CNPJ", "Valor", "Observação", "Utilizado"};

    public ChequesJTableModel() {
        dados = new ArrayList<>();
    }

    public ChequesJTableModel(List<Cheque> ChequeList) {
        dados = ChequeList;
    }
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        try {
            ...
            switch (columnIndex) {
                ...
                case 10:
                    return DateTime.toStringDataAbreviada(cheque.getUtilizado());
            }
        } catch (Exception e) {
            //nada
        }
