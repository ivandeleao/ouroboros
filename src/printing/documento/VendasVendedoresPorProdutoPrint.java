...
public class VendasVendedoresPorProdutoPrint {
    ...
    public static void gerarA4(List<Venda> documentos, LocalDate dataInicial, LocalDate dataFinal) {
        try {
            if (documentos.isEmpty()) {
                ...
                String relatorio = (APP_PATH + "\\reports\\VendasVendedoresPorProduto.jasper");
                ...
                itens.sort(Comparator.comparing(
                        i -> i.getVendedor() != null ? i.getVendedor().getNome() : ""
                ));
                ...
                for (ProdutoPorVendedorConsolidado i : itens) {
                    ...
                    System.out.println("---------------------------------------------");
                    System.out.print("Produto: " + iPrint.getProduto());
                    System.out.println("\tvendedor: " + iPrint.getVendedor());

                    itensPrint.add(iPrint);
                }

                //Ordem dos itens dentro de cada grupo
                itensPrint.sort(Comparator.comparing(VendaItemConsolidadoReportBean::getProduto));
